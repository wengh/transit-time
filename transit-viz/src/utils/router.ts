...
/// Per-node travel times (seconds) for one departure. Length = num_nodes;
/// `65535` marks unreachable. The returned array aliases WASM memory and is
/// overwritten by the next call — finish reading (e.g. upload to GL) first.
